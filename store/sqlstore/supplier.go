...
func NewSqlSupplier(settings model.SqlSettings) *SqlSupplier {
	...
	supplier.oldStores.plan.(*SqlPlanStore).CreateIndexesIfNotExists()
	return supplier
}
...
func (ss *SqlSupplier) Plan() store.PlanStore {
	return ss.oldStores.plan
}
